...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-[20] bg-[#f8f8f8] justify-center ">
      <div className="bg-white rounded-lg xl:h-[80vh] flex gap-6 xl:gap-16 flex-wrap justify-center items-center p-14 pt-6 w-[60%] ">
        <div>
          <div>
                ...
                {videoAsset ? (
                  <div className="mb-20">
                    <video
                      ...
                      loop
                      controls
                      className="rounded-xl h-[350px] w-[250px] aspect-square mt-16 bg-black"
                    ></video>
                  </div>
                ) : (
                  <label className="cursor-pointer">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="bg-[#f51997] text-center mt-10 font-medium p-2 rounded text-white w-52 outline-none ">
                        Select File
                      </p>
                    </div>
                    <input
